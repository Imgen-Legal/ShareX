...
namespace ShareX
{
    public class QuickTaskInfo
    {
        ...
        {
            new QuickTaskInfo("Save, Upload, Copy URL", AfterCaptureTasks.SaveImageToFile, AfterUploadTasks.CopyURLToClipboard),
            new QuickTaskInfo("Save, Copy image", AfterCaptureTasks.SaveImageToFile | AfterCaptureTasks.CopyImageToClipboard),
            new QuickTaskInfo("Annotate, Save, Upload, Copy URL", AfterCaptureTasks.AnnotateImage | AfterCaptureTasks.SaveImageToFile, AfterUploadTasks.CopyURLToClipboard),
            new QuickTaskInfo(),
